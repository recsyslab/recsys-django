...
--------+--------------------------------------+-------+-------
 public | accounts_customuser                  | table | 【ユーザ名】
 public | accounts_customuser_groups           | table | 【ユーザ名】
 public | accounts_customuser_user_permissions | table | 【ユーザ名】
 public | auth_group                           | table | 【ユーザ名】
 public | auth_group_permissions               | table | 【ユーザ名】
 public | auth_permission                      | table | 【ユーザ名】
 public | django_admin_log                     | table | 【ユーザ名】
 public | django_content_type                  | table | 【ユーザ名】
 public | django_migrations                    | table | 【ユーザ名】
 public | django_session                       | table | 【ユーザ名】
(10 rows)
```
